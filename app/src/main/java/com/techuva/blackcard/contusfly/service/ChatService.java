 ...
 */
package com.techuva.blackcard.contusfly.service;
...
import com.techuva.blackcard.contusfly.model.ChatMsg;
import com.techuva.blackcard.contusfly.model.MDatabaseHelper;
import com.techuva.blackcard.contusfly.model.Rosters;
import com.techuva.blackcard.contusfly.utils.ChatUtils;
import com.techuva.blackcard.contusfly.utils.Constants;
import com.techuva.blackcard.contusfly.utils.ImageCompressor;
import com.techuva.blackcard.contusfly.utils.ImageUploadS3;
import com.techuva.blackcard.contusfly.utils.LogMessage;
import com.techuva.blackcard.contusfly.utils.MediaPaths;
...
import static com.techuva.blackcard.contusfly.utils.Constants.CHAT_RECEIVED_RECEIPT_SENT;
...
public class ChatService extends Service {
    ...
    private List<com.corporate.contus_Corporate.chatlib.models.ChatMessage> smackGroupChatMessages;
    /**
     ...
     */
    private com.techuva.blackcard.contusfly.utils.MApplication mApplication;
    ...
    public void onCreate() {
        super.onCreate();
        mApplication = (com.techuva.blackcard.contusfly.utils.MApplication) getApplicationContext();
    ...
    private void loadConnection(String resourceAppend) {
        ConnectionSettings settings = new com.corporate.contus_Corporate.chatlib.ConnectionSettings();
    ...
    private boolean checkGroup(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
    ...
    private synchronized void receivedMessage(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatmsg) {
        if (mApplication.getBooleanFromPreference(Constants.IS_CONTACTS_SYNCED)) {
            ...
            if (!chatFrom.equalsIgnoreCase(mApplication.getStringFromPreference(Constants.USERNAME)) && checkGroup(chatmsg)) {
                ...
                if (checkMediaAvailable(mChatMsg)) {
                    ...
                    if (inserted == 1) {
                        String ongoingChatPerson = mApplication.returnEmptyStringIfNull(mApplication.getStringFromPreference(Constants.CHAT_ONGOING_NAME));
...
//                    controller.logout();
    ...
    public void sendGroupChat(String to, String msg, String messageType, String mid, String chatType, String mTime, String broadcastId) {
        com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage = new com.corporate.contus_Corporate.chatlib.models.ChatMessage();
        String username = mApplication.getStringFromPreference(Constants.USERNAME);
     ...
     */
    public void updateMsgStatus(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage, int status) {
     ...
     * @return the chat msg
     */
    private ChatMsg convertMsgFormat(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage, String chatType, String chatFrom) {
    ...
    private class ProfileCallbackListener implements RosterListener {
        ...
        @Override
        public void userProfileUpdateCallback(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
            if (mApplication.getBooleanFromPreference(Constants.IS_CONTACTS_SYNCED))
                controller.getContacts();
        }
    ...
    private class GroupCallbackListener implements GroupListener {
        ...
        @Override
        public void groupChatNewUser(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatmsg) {
        ...
        @Override
        public void groupChatRemoveUser(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatmsg) {
            String gid = chatmsg.getFrom();
        ...
        @Override
        public void groupChatInfoUpdate(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatmsg) {
            String gid = chatmsg.getFrom();
            List<Rosters> rosterInfo = MDatabaseHelper.getRosterInfo(gid,
                    Constants.ROSTER_GROUP_USERS);
            if (rosterInfo != null && !rosterInfo.isEmpty()) {
                ...
                for (int i = 0, count = groups.size(); i < count; i++) {
                    ...
                    try {
                        ...
                        if (smackGroupChatMessages.size() > 0) {
                            for (com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage : smackGroupChatMessages) {
    ...
    class SmackMessageListener implements com.corporate.contus_Corporate.chatlib.listeners.MessageListener {

        @Override
        public void messageCallback(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
            receivedMessage(chatMessage);
        }

        @Override
        public void messageAcknowledgementCallback(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
        ...
        @Override
        public void messageReceiptCallback(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
            String id = chatMessage.getMid();
            String user = chatMessage.getFrom();
            id = id.replaceAll("-" + user, "");
        ...
        @Override
        public void messageSeenCallback(com.corporate.contus_Corporate.chatlib.models.ChatMessage chatMessage) {
            String id = chatMessage.getMid();
            String user = chatMessage.getFrom();
            id = id.replaceAll("-" + user, "");
