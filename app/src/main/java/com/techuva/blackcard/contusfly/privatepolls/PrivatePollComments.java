package com.techuva.blackcard.contusfly.privatepolls;
...
import com.techuva.blackcard.contus.restclient.CommentsDisplayRestClient;
import com.techuva.blackcard.contus.restclient.CommentsPollRestClient;
...
import static com.techuva.blackcard.contus.app.Constants.COMMENTS_COUNT_POLL_REVIEW;
import static com.techuva.blackcard.contus.app.Constants.COMMENTS_COUNT_POSITION;
import static com.techuva.blackcard.contus.app.Constants.POLL_ID;
import static com.techuva.blackcard.contus.app.Constants.USER_POLL_COMMENTS_COUNT;
import static com.techuva.blackcard.contus.app.Constants.USER_POLL_COMMENTS_SIZE;
...
public class PrivatePollComments extends Activity implements EndLessListView.EndlessListener {
    ...
    public void initViews() {
        ...
        userPollId = getIntent().getExtras().getString(POLL_ID);
        //Position  from the intent
        userCommentsCountPosition = getIntent().getExtras().getInt(COMMENTS_COUNT_POSITION);
    ...
    private void pollCommentsAddResponse(CommentDisplayResponseModel comments) {
        ...
        prefrenceUserPollCommentsCount = MApplication.loadArray(pollCommentsActivity, userPollcommentsCount, USER_POLL_COMMENTS_COUNT, USER_POLL_COMMENTS_SIZE);
        ...
        MApplication.saveArray(pollCommentsActivity, prefrenceUserPollCommentsCount, USER_POLL_COMMENTS_COUNT, USER_POLL_COMMENTS_SIZE);
        //Setting the count in prefernce
        MApplication.setString(pollCommentsActivity, COMMENTS_COUNT_POLL_REVIEW, comments.getCount());
