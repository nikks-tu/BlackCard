...
public class CreatePollOptionsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position==0){
            mCategory= MApplication.loadStringArray(context,mCategory, ACTIVITY_CATEGORY_INFO,Constants.ACTIVITY_CATEGORY_INFO_SIZE);
       Log.e("mCategory",mCategory+"");
        ...
        MApplication.saveStringArray(context,mCategory, ACTIVITY_CATEGORY_INFO,Constants.ACTIVITY_CATEGORY_INFO_SIZE);
        return convertView;
    }
