package com.techuva.blackcard.contusfly.createpoll;
...
import com.techuva.blackcard.contusfly.adapters.AdapterContactsInfo;
import com.techuva.blackcard.contusfly.chooseContactsDb.ChooseContactsModelClass;
...
import com.techuva.blackcard.contusfly.utils.ItemClickSupport;
import com.techuva.blackcard.contusfly.views.CustomRecyclerView;
import com.techuva.blackcard.contusfly.views.DoProgressDialog;

import java.util.ArrayList;
import java.util.List;

import static com.techuva.blackcard.contusfly.app.Constants.ACTIIVTY_CONTACT_INFO_SIZE;
import static com.techuva.blackcard.contusfly.app.Constants.ACTIIVTY_CONTACT_NAME_INFO_SIZE;
import static com.techuva.blackcard.contusfly.app.Constants.ACTIVITY_CATEGORY_INFO;
import static com.techuva.blackcard.contusfly.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE;
import static com.techuva.blackcard.contusfly.app.Constants.ACTIVITY_CONTACT_INFO;
import static com.techuva.blackcard.contusfly.app.Constants.ACTIVITY_CONTACT_NAME_INFO;
import static com.techuva.blackcard.contusfly.utils.Constants.CONTACT;
...
public class ContactDisplay extends ActivityBase implements
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
       ...
       db=new DatabaseHelper(mContactDisplay);
        ...
        mContactTitle = MApplication.loadStringArray(mContactDisplay, mCategory, ACTIVITY_CATEGORY_INFO, ACTIVITY_CATEGORY_INFO_SIZE);
    ...
    private void setControls() {
        try {
            ...
            mContactName = mApplication.loadStringArray(mContactDisplay, mContactName, ACTIVITY_CONTACT_NAME_INFO, ACTIIVTY_CONTACT_NAME_INFO_SIZE);
            mArrayList = mApplication.loadStringArray(mContactDisplay, mArrayList, ACTIVITY_CONTACT_INFO, ACTIIVTY_CONTACT_INFO_SIZE);
            ...
            ItemClickSupport.addTo(listMembers).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    if (checkBox.isChecked()) {
                        db.update(mContacts.getRosterID(),mContacts.getRosterName(), CONTACT,0,1);
                        ...
                        Log.e("Lis31",db.getAllContacts()+"");
                            if (!db.checkEvent(mContacts.getRosterID())) {
                                ...
                                db.addContact(mContacts.getRosterID(), mContacts.getRosterName(), CONTACT, 0, 0);
                                checkBox.setChecked(true);
                                Log.e("List1", db.getAllContacts() + "");
                            }else{
                                db.update(mContacts.getRosterID(),mContacts.getRosterName(), CONTACT,0,0);
                                checkBox.setChecked(true);
                            }
                        }
                }
            ...
            case R.id.txt_create:
                ...
                if(!checkedIds.isEmpty()) {
                    for (int i = 0; i < checkedIds.size(); i++) {
                        db.update(checkedIds.get(i).getId(),checkedIds.get(i).getName(), CONTACT, 1, 1);
                    }
                }
