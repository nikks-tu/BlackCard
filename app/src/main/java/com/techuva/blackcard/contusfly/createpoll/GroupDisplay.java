...
import com.techuva.blackcard.contusfly.adapters.AdapterGroupInfo;
...
import static com.techuva.blackcard.contus.app.Constants.ACTIIVTY_GROUP_INFO_SIZE;
import static com.techuva.blackcard.contus.app.Constants.ACTIVITY_CATEGORY_INFO;
import static com.techuva.blackcard.contus.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE;
import static com.techuva.blackcard.contus.app.Constants.ACTIVITY_GROUP_INFO;
...
public class GroupDisplay extends ActivityBase implements
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContactTitle = MApplication.loadStringArray(groupInfoActivity, mCategory, ACTIVITY_CATEGORY_INFO, ACTIVITY_CATEGORY_INFO_SIZE);
        ...
        try {
            ...
            ItemClickSupport.addTo(listMembers).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    mArrayList = mApplication.loadStringArray(groupInfoActivity, mArrayList, ACTIVITY_GROUP_INFO, ACTIIVTY_GROUP_INFO_SIZE);
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_create:
                ...
                if(!checkedIds.isEmpty()) {
                    ...
                    mApplication.saveStringArray(groupInfoActivity, mCategory, ACTIVITY_CATEGORY_INFO, ACTIVITY_CATEGORY_INFO_SIZE);
                }
