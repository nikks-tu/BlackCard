...
import static com.techuva.blackcard.contus.app.Constants.GCM_REG_ID;
...
public abstract class ActivityBaseFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String deviceID = mApplication.returnEmptyStringIfNull(MApplication.getString(getActivity(), GCM_REG_ID));
