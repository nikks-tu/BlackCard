...
import static com.techuva.blackcard.contus.app.Constants.DILETE_COMMENTS;
    ...
    public void updatedComments(String announcementid, String commentsid , String commnts)
        {
            ...
            CustomRequest.makeJsonObjectRequest(activity, DILETE_COMMENTS,obj, new VolleyResponseListener() {
                @Override
