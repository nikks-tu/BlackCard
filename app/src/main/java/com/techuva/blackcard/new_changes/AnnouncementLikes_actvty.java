package com.techuva.blackcard.new_changes;
...
import com.techuva.blackcard.new_changes.adapters.LikedListAdapter;
import com.techuva.blackcard.new_changes.models.LikeListModel;
...
import static com.techuva.blackcard.contus.app.Constants.ANNOUNCEMNET_LIKES;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imagBackArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               //
                MApplication.setBoolean(getApplicationContext(), Constants.IS_Announcement, true);
