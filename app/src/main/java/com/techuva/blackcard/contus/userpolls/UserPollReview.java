...
import com.techuva.blackcard.contus.responsemodel.PollReviewResponseModel;
import com.techuva.blackcard.contus.restclient.LikesAndUnLikeRestClient;
import com.techuva.blackcard.contus.restclient.PollReviewsRestClient;
...
public class UserPollReview extends Activity {
    ...
    public void init() {
        ...
        pollReviewRequest();
        //Setting the comments count in preference
        MApplication.setString(mUserPollReview, Constants.COMMENTS_COUNT_POLL_REVIEW, commentsCount);
        mAdView = findViewById(R.id.adView);
        //heading
        title =  findViewById(R.id.title);

        Typeface face = Typeface.createFromAsset(mUserPollReview.getAssets(), "fonts/Quicksand-Light.ttf");
    ...
    private void fourthReview(final PollReviewResponseModel pollResponseModelView4) {
        ...
        Typeface face = Typeface.createFromAsset(mUserPollReview.getAssets(), "fonts/Quicksand-Light.ttf");
        Typeface faceRegular = Typeface.createFromAsset(mUserPollReview.getAssets(), "fonts/Quicksand-Regular.otf");
        //Initializing the views.
        ...
        userPollView4.userPollHeaderNameYouTubeLayout.setTypeface(faceRegular);
        userPollView4.userPolltxtTimeYouTubeLayout.setTypeface(face);
        userPollView4.userPollHeaderCategoryYouTubeLayout.setTypeface(face);
        ...
        if(userPollupdatedTime!=null)
        {
            String strCurrentDate = userPollupdatedTime;
            ...
            userPollView4.userPolltxtTimeYouTubeLayout.setText(date);
        }
        else
        {
        }
    ...
    private void thirdReview(PollReviewResponseModel pollReviewResponseModelView3) {
        ...
        userPollView3.userPollPhotoComparisonHeaderName.setTypeface(faceRegular);
        userPollView3.userPollPhotoComparisontxtTime.setTypeface(face);
        userPollView3.userPollPhotoComparisonHeaderCategory.setTypeface(face);
        if(userPollupdatedTime!=null)
        {
            String strCurrentDate = userPollupdatedTime;
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
            ...
            format = new SimpleDateFormat("dd-MMM-yy");
            String date = format.format(newDate);
            userPollView3.userPollPhotoComparisontxtTime.setText(date);
        }
        else
        {
        }
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void secondReview(PollReviewResponseModel pollResponseModelView2) {
        ...
        viewHolder2.userPollHeaderImageMultipleOptions = findViewById(R.id.imgProfile);
        ...
        viewHolder2.userPolltxtThirdOptionCountMultipleOptions =  findViewById(R.id.txtThirdOptionCount);
        viewHolder2.userPolltxtFourthOptionCountMultipleOptions = findViewById(R.id.txtFourthOptionCount);
        viewHolder2.userPollprogressbarFirstOptionMultipleOptions = findViewById(R.id.progressbarFirstOption);
        viewHolder2.userPollprogressbarSecondOptionMultipleOptions = findViewById(R.id.progressbarSecondOption);
        viewHolder2.userPollprogressbarThirdOptionMultipleOptions =  findViewById(R.id.progressbarThirdOption);
        viewHolder2.userPollprogressbarFourthOptionMultipleOptions =  findViewById(R.id.progressbarFourthOption);
        viewHolder2.userPollrelativePrgressBar3MultipleOptions = findViewById(R.id.relativeProgressbar3);
        viewHolder2.userPollrelativePrgressBar4MultipleOptions = findViewById(R.id.relativeProgressbar4);
        viewHolder2.userPolltxtCountsMultipleOptions =  findViewById(R.id.txtParticcipation);
        ...
        viewHolder2.userPollHeaderNameMultipleOptions.setTypeface(faceRegular);
        viewHolder2.userPolltxtTimeMultipleOptions.setTypeface(face);
        viewHolder2.userPollHeaderCategoryMultipleOptions.setTypeface(face);
        ...
        if(userPollupdatedTime!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy");
            String date = format.format(newDate);
            viewHolder2.userPolltxtTimeMultipleOptions.setText(date);
        }
        else
        {
        }
...
//If the user poll image 1 and image 2 is empty then the both the visiblity is gone
    ...
    private void firstReview(PollReviewResponseModel pollResponseModelView1) {
        ...
        viewHolder1.userPollHeaderImageYesOrNO =  findViewById(R.id.imgProfile);
        ...
        viewHolder1.userPollHeaderNameYesOrNO.setTypeface(faceRegular);
        viewHolder1.userPolltxtTimeYesOrNO.setTypeface(face);
        viewHolder1.userPollHeaderCategoryYesOrNO.setTypeface(face);
        ...
        if(userPollupdatedTime!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy");
            String date = format.format(newDate);
            viewHolder1.userPolltxtTimeYesOrNO.setText(date);
        }
        else
        {
        }
    ...
    private void likesUnLikes(final int clickPosition) {
        ...
        LikesAndUnLikeRestClient.getInstance().postCampaignPollLikes(new String("poll_likes"), new String(userId), new String(userPollId), new String(String.valueOf(mlikes))
            ...
            public void success(LikeUnLikeResposneModel likesUnlike, Response response) {
                ...
                //Changing the value in text view
