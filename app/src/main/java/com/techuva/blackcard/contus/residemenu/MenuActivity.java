package com.techuva.blackcard.contus.residemenu;
...
import com.techuva.blackcard.contus.aboutus.AboutUs;
import com.techuva.blackcard.contus.app.Constants;
import com.techuva.blackcard.contus.category.Category;
import com.techuva.blackcard.contus.category.IFragmentReplace;
import com.techuva.blackcard.contus.contactus.ContactUs;
import com.techuva.blackcard.contus.mypolls.MyPolls;
import com.techuva.blackcard.contus.myprofile.EditProfile;
import com.techuva.blackcard.contus.myprofile.MyProfile;
import com.techuva.blackcard.contus.publicpoll.PublicPoll;
import com.techuva.blackcard.contus.restclient.UserPollRestClient;
import com.techuva.blackcard.contus.search.SearchActivity;
import com.techuva.blackcard.contus.settings.Settings;
import com.techuva.blackcard.contus.userpolls.ComplaintFragment;
import com.techuva.blackcard.contus.userpolls.UserPolls;
import com.techuva.blackcard.contusfly.chat.HomeChat;
import com.techuva.blackcard.contusfly.chooseContactsDb.DatabaseHelper;
import com.techuva.blackcard.contusfly.createpoll.MultipleOptions;
import com.techuva.blackcard.contusfly.createpoll.PhotoComparison;
import com.techuva.blackcard.contusfly.createpoll.YesOrNo;
import com.techuva.blackcard.contusfly.fragments.FragmentContacts;
import com.techuva.blackcard.contusfly.fragments.FragmentRecentChats;
import com.techuva.blackcard.contusfly.model.PollUnseenStatusModel;
import com.techuva.blackcard.contusfly.utils.Utils;
import com.techuva.blackcard.contusfly.views.CircularImageView;
import com.techuva.blackcard.new_changes.fragments.Announcements;
import com.techuva.blackcard.new_changes.fragments.SearchAnnouncements;
...
import static com.techuva.blackcard.contus.app.Constants.GET_MESSAGE_UNREAD_COUNT;
...
public class MenuActivity extends AppCompatActivity implements FragmentManager.OnBackStackChangedListener, IFragmentReplace, View.OnClickListener, MyPolls.MyPollsOnInteractionListner, UserPolls.UserPollOnFragmentInteractionListner, PublicPoll.CampaignPollInteractionListner {
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* getPrivatePollChatUnseenCount =  userPoll.findViewById(R.id.get_unseen_chat_count_unseen_window);
        ...
        MApplication.setBoolean(mContext, Constants.IS_Announcement, false);
        MApplication.setBoolean(mContext, Constants.IS_Complaint, false);
        ...
        String getBatchCount = mApplication.getStringFromPreference(GET_MESSAGE_UNREAD_COUNT);
    ...
    private void setUpMenu() {
        ...
        // create itemSettings items
         itemSettings = new ResideMenuItem(this, R.drawable.complaints, getResources().getString(R.string.grievance), false);
...
//////////////////////////////
        if (view == itemSettings) {
            ...
            layoutTop.setVisibility(View.VISIBLE);
            //title
            title =  itemSettings.findViewById(R.id.tv_title);
            //icon
            icon =  itemSettings.findViewById(R.id.iv_icon);
            //title color
            title.setTextColor(getResources().getColor(R.color.helvetica_light_greycolor));
            //icon color
            icon.setColorFilter(getResources().getColor(R.color.helvetica_light_greycolor));
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative =  itemSettings.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
        ...
        if (view == itemProfile) {
            ...
            if (imgProfile.getVisibility() == View.VISIBLE) {
                ...
                toolbar.setVisibility(View.VISIBLE);
                txtTitle1.setText(getResources().getString(R.string.activity_myprofile));
                Typeface face = Typeface.createFromAsset(getAssets(), "fonts/Quicksand-Light.ttf");
                txtTitle1.setTypeface(face);
                //This view contains only create poll icon
    ...
    private boolean isInMyPollsFragment() {
        for (Fragment item : getSupportFragmentManager().getFragments()) {
            // if (item.isVisible() && "HomeActivity".equals(item.getClass().getSimpleName())) {
            if (item.isVisible() && "MyPolls".equals(item.getClass().getSimpleName())) {
                return true;
            }
        }
        return false;
    }
    private boolean isInMyProfileFragment() {
        for (Fragment item : getSupportFragmentManager().getFragments()) {
            // if (item.isVisible() && "HomeActivity".equals(item.getClass().getSimpleName())) {
            if (item.isVisible() && "MyProfile".equals(item.getClass().getSimpleName())) {
                return true;
            }
        }
        return false;
    ...
    private boolean isInComplaintFragment() {
        for (Fragment item : getSupportFragmentManager().getFragments()) {
            // if (item.isVisible() && "HomeActivity".equals(item.getClass().getSimpleName())) {
            if (item.isVisible() && "ComplaintFragment".equals(item.getClass().getSimpleName())) {
                return true;
            }
        }
        return false;
    ...
    public void onBackPressed() {
        ...
        ll_tool.setVisibility(View.VISIBLE);
        mTitle.setVisibility(View.VISIBLE);
        exitToast = Toast.makeText(getApplicationContext(), mContext.getResources().getString(R.string.back_press_msg), Toast.LENGTH_SHORT);
        ...
        else if (isInPollsFragment() || isInMyPollsFragment()|| isInMyProfileFragment()) {
            ll_tool.setVisibility(View.VISIBLE);
            mTitle.setText("Polls");
            btnCreatePoll.setVisibility(View.VISIBLE);
            announcementtextPublic.setTextColor(getResources().getColor(R.color.grey_color_text));
    ...
    protected void onResume() {
      ...
      /*  userPoll.setVisibility(View.GONE);
        ...
        imagePublic_.setImageDrawable(mContext.getResources().getDrawable(R.drawable.announceblue));
        imageUser.setImageDrawable(mContext.getResources().getDrawable(R.drawable.userpollgray));*/
        if (MApplication.getBoolean(mContext, Constants.SEARCH_BACKPRESS_BOOLEAN)) {
            Log.e("usermy", "usermy");
            announcementtextPublic.setTextColor(getResources().getColor(R.color.grey_color_text));
            announcementtextUser.setTextColor(getResources().getColor(R.color.grey_color_text));
            userpolltext.setTextColor(getResources().getColor(R.color.text_colore_blue));
        ...
        else if(MApplication.getBoolean(mContext, Constants.IS_Announcement))
        {
            toolbar.setVisibility(View.VISIBLE);
            layoutTop.setVisibility(View.GONE);
            Typeface faceRegular = Typeface.createFromAsset(getAssets(), "fonts/Quicksand-Regular.otf");
        ...
        else if(MApplication.getBoolean(mContext, Constants.IS_Complaint))
        {
            userPoll.setVisibility(View.GONE);
            publicPoll.setVisibility(View.GONE);
            toolbar.setVisibility(View.GONE);
        ...
        else if(MApplication.getBoolean(mContext, Constants.IS_MyPolls))
        {
            userPoll.setVisibility(View.GONE);
            publicPoll.setVisibility(View.GONE);
            toolbar.setVisibility(View.GONE);
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (getChatViewUnseenCount != null && getPublicPollChatUnseenCount != null && getPrivatePollChatUnseenCount != null) {
                    getChatViewUnseenCount.setText(mApplication.getStringFromPreference(GET_MESSAGE_UNREAD_COUNT));
                    getPublicPollChatUnseenCount.setText(mApplication.getStringFromPreference(GET_MESSAGE_UNREAD_COUNT));
                    getPrivatePollChatUnseenCount.setText(mApplication.getStringFromPreference(GET_MESSAGE_UNREAD_COUNT));
