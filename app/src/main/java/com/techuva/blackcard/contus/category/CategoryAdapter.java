package com.techuva.blackcard.contus.category;
...
import static com.techuva.blackcard.contus.app.Constants.CATEGORY_COUNT_ARRAY;
import static com.techuva.blackcard.contus.app.Constants.CATEGORY_COUNT_SIZE;
...
public class CategoryAdapter extends ArrayAdapter<CategoryPollResponseModel.Results> {
    ...
    public View getView(final int position, View mCategory, ViewGroup parent) {
       ...
       // if (!categoryModel.get(position).getCategoryName().equals("Admin"))
        ...
        prefernceCategorySaveArray = MApplication.loadStringArray(context, categoryArray, CATEGORY_COUNT_ARRAY, CATEGORY_COUNT_SIZE);
        ...
        if (MApplication.getBoolean(context, YES_OR_NO)) {
            //View gone
            holder.imageButtonUnSelect.setVisibility(View.GONE);
            //Viw gone
            holder.imageButton.setVisibility(View.GONE);
    ...
    private void categoryClickAction(ViewHolder finalHolder, int clickposition) {
        ...
        if (finalHolder.imageButtonUnSelect.getVisibility() == View.VISIBLE) {
            ...
            MApplication.saveStringArray(context, prefernceCategorySaveArray, CATEGORY_COUNT_ARRAY, CATEGORY_COUNT_SIZE);
        } else {
            //View visible
