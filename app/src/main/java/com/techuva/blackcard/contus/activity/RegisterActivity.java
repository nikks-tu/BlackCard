...
import com.techuva.blackcard.contus.restclient.MobileNumberCheckRestClient;
...
import com.techuva.blackcard.new_changes.SignUpActivity;
...
public class RegisterActivity extends Activity implements Constants, Utils.ContactResult {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        exitToast = Toast.makeText(getApplicationContext(), "Press back again to exit BlackCard App", Toast.LENGTH_SHORT);
