...
import com.techuva.blackcard.contus.responsemodel.TermsAndConditionModel;
import com.techuva.blackcard.contus.restclient.TermsConditionRestClient;
...
public class TermsAndCondition extends Activity implements Constants {
    ...
    private void termsResponse(TermsAndConditionModel termsResponseModel) {
       ...
       //progressive stop
        ...
        txtInformation.setWebViewClient(new WebViewClient());
        txtInformation.loadUrl("https://google.com");
