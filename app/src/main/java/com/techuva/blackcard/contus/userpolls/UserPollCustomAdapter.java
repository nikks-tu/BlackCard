package com.techuva.blackcard.contus.userpolls;
...
import com.techuva.blackcard.contus.comments.PollComments;
...
public class UserPollCustomAdapter extends ArrayAdapter<UserPollResponseModel.Results.Data> implements CompoundButton
    ...
    private void imageQuestionClickAction(int clickPosition, String pollImageMyPoll) {
        ...
        if(userPollResponse.getUpdatedAt()!=null)
        {
            MApplication.setString(userPollActivity, Constants.DATE_UPDATED, userPollResponse.getUpdatedAt());
        }
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holderUserView1.txtNameYesOrNoPoll.setTypeface(faceRegular);
            holderUserView1.txtTimeYesOrNoPoll.setTypeface(face);
            holderUserView1.txtCategoryYesOrNoPoll.setTypeface(face);
            ...
            holderUserView2.radioGroupOptionsMultipleOptionsUserPoll =  mMyPollsView
                    .findViewById(R.id.participate_options);
            holderUserView2.radioOptions1MultipleOptionsUserPoll = mMyPollsView
                    .findViewById(R.id.option1);
            holderUserView2.radioOptions2MultipleOptionsUserPoll =  mMyPollsView
                    .findViewById(R.id.option2);
            holderUserView2.radioOptions3MultipleOptionsUserPoll =  mMyPollsView
                    .findViewById(R.id.option3);
            holderUserView2.radioOptions4MultipleOptionsUserPoll =  mMyPollsView
                    .findViewById(R.id.option4);
            holderUserView2.likeUnlikeMultipleOptionsUserPoll =  mMyPollsView
                    .findViewById(R.id.unLikeDislike);
            ...
            holderUserView2.txtNameMultipleOptionsUserPoll.setTypeface(faceRegular);
            holderUserView2.txtTimeMultipleOptionsUserPoll.setTypeface(face);
            holderUserView2.txtCategoryMultipleOptionsUserPoll.setTypeface(face);
            //Binding the data into the views in android
            ...
            holderUserView3.radioOptions4PhotoComparisonUserPoll =  mMyPollsView
                    .findViewById(R.id.option4);
            holderUserView3.likeUnlikePhotoComparisonUserPoll =  mMyPollsView
                    .findViewById(R.id.unLikeDislike);
            ...
            holderUserView3.likeUnlikePhotoComparisonUserPoll =  mMyPollsView
                    .findViewById(R.id.unLikeDislike);
            holderUserView3.txtLikePhotoComparisonUserPoll =  mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView3.txtCommentsPhotoComparisonUserPoll =  mMyPollsView
                    .findViewById(R.id.txtCommentsCounts);
            ...
            holderUserView3.txtCategoryPhotoComparisonUserPoll.setTypeface(face);
            holderUserView3.txtNamePhotoComparisonUserPoll.setTypeface(faceRegular);
            holderUserView3.txtTimePhotoComparisonUserPoll.setTypeface(face);
            //Binding the data into the views in android
            ...
            holderUserView4.txtCategoryYouTubeUrlUserPoll.setTypeface(face);
            holderUserView4.txtNameYouTubeUrlUserPoll.setTypeface(faceRegular);
            holderUserView4.txtTimeYouTubeUrlUserPoll.setTypeface(face);
            //Binding the data into the views in android
    ...
    private void validateViewLayoutOne(final ViewHolderLayoutOne holder, final int position) {
        ...
        if(userPollResponse.getUpdatedAt()!=null)
        {
            String strCurrentDate = userPollResponse.getUpdatedAt();
            ...
            holder.txtTimeYesOrNoPoll.setText(date);
        }
        else
        {
        }
    ...
    private void validateViewLayoutTwo(final ViewHolderLayoutTwo holder, final int position) {
        ...
        } else if (!false) {  //If the poll answer option is not empty then the view will invisible
        ...
        if(userPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimeMultipleOptionsUserPoll.setText(date);
        }
        else
        {
        }
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void shareClickAction(int clickPosition) {
        ...
        MApplication.shareGmail(userPollActivity, shareUrl, MApplication
    ...
    private void validateViewLayoutThree(final ViewHolderLayoutThree holder, final int position) {
        ...
        if(userPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimePhotoComparisonUserPoll.setText(date);
        }
        else
        {
        }
        ...
        holder.radioOptions3PhotoComparisonUserPoll
                .setOnCheckedChangeListener(new RadioButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        pollAnswerSelectedId = "3";
                        pollAnswer = userPollResponse.getUserPollsAns().get(0).getPollAnswer3();
                        optionSelection(userPollResponse, position, null, null, holder, null);
                    }
    ...
    private void validateViewLayoutFour(final ViewHolderLayoutFour holder, final int position) {
        ...
        if(userPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimeYouTubeUrlUserPoll.setText(date);
        }
        else
        {
        }
...
//
        ...
        holder.radioOptions1YouTubeUrlUserPoll.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (!view.isClickable()) {
                    ...
                    pollAnswer = userPollResponse.getUserPollsAns().get(0).getPollAnswer1();
                    //Option selection request
                    optionSelection(userPollResponse, position, null, null, null, holder);
                }
                return false;
            }
        });
    ...
    private void optionSelection(final UserPollResponseModel.Results.Data userPollResponse, final int clickPosition,
        ...
        PollParticipateRestClient.getInstance()
                                 .postParticipateApi(new String("polls_participate"), new String(userId), new String
                                                 (pollId), new String(pollAnswerId), new String(pollAnswer), new
                                                 String(pollAnswerSelectedId), new String("1")
