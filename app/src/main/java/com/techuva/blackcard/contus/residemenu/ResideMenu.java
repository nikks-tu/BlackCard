...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context) {
        ...
        imageViewShadow = (ImageView) findViewById(R.id.ic_shadow);
        layoutLeftMenu = (LinearLayout) findViewById(R.id.layout_left_menu);
        icUser = (ImageView) findViewById(R.id.ic_user);
        ...
        //Getting the url from prefernce
    ...
    public void openMenu(int direction) {
        ...
        //Setting the user name in text view
        txtUserName.setText(MApplication.getDecodedString(MApplication.getString(getContext(), PROFILE_USER_NAME)));
