...
package com.techuva.blackcard.contus.aboutus;
...
public class AboutUs extends Fragment {
    ...
    private void termsResponse(TermsAndConditionModel termsResponseModel) {
        ...
        webDetails.loadData(Html.fromHtml("<html><body style='text-align:justify;'>" + termsMessage + "</body></html>").toString(),"text/html", "utf-8");
