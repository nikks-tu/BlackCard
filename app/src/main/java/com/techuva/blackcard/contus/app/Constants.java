package com.techuva.blackcard.contus.app;
...
public interface Constants {
    ...
    //Production Base URL
    String LIVE_BASE_URL = "https://mypollbook.com/Blackcard/";
    String GET_ANNOUNCEMENT = LIVE_BASE_URL+"api/v1/announcements";
    String SEARCH_ANNOUNCEMENT = "api/v1/searchAnnouncement";
    ...
    String Add_Complaint = "api/v1/complaints";
   ...
   String SIGNUP_NEW_USER = "api/v1/sign_up";
    ...
    String Yes_Or_No_Create = "Yes_Or_No_Create";
    String IS_Announcement = "IS_Announcement";
    String IS_Complaint = "IS_Complaint";
    String IS_MyPolls = "IS_MyPolls";
}
