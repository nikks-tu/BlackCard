package com.techuva.blackcard.contus.search;
...
public class SearchAdapter extends ArrayAdapter<UserPollResponseModel.Results.Data> {
    ...
    private void imageQuestionClickAction(int clickPosition, String pollImageMyPoll) {
        ...
        assert searchPollResponseModel != null;
        MApplication.setString(context, Constants.DATE_UPDATED, searchPollResponseModel.getUpdatedAt());
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holderSearchView1.txtNameYesOrNoSearchPoll.setTypeface(faceRegular);
            holderSearchView1.txtTimeYesOrNoSearchPoll.setTypeface(face);
            holderSearchView1.txtCategoryYesOrNoSearchPoll.setTypeface(face);
            //Binding the data into the views in android
            holderSearchView1.imgShareYesOrNoSearchPoll.setVisibility(View.GONE);
            ...
            //Binding the data into the views in android
            holderSearchView2.txtNameMultipleOptionsSearchPoll.setTypeface(faceRegular);
            holderSearchView2.txtTimeMultipleOptionsSearchPoll.setTypeface(face);
            holderSearchView2.txtCategoryMultipleOptionsSearchPoll.setTypeface(face);
            holderSearchView2.imgShareMultipleOptionsSearchPoll.setVisibility(View.GONE);
            ...
            //Binding the data into the views in android
            holderSearchView3.txtNamePhotoComparisonSearchPoll.setTypeface(faceRegular);
            holderSearchView3.txtTimePhotoComparisonSearchPoll.setTypeface(face);
            holderSearchView3.txtCategoryPhotoComparisonSearchPoll.setTypeface(face);
            holderSearchView3.imgSharePhotoComparisonSearchPoll.setVisibility(View.GONE);
            ...
            //Binding the data into the views in android
            holderSearchView4.txtNameYouTubeUrlSearchPoll.setTypeface(faceRegular);
            holderSearchView4.txtTimeYouTubeUrlSearchPoll.setTypeface(face);
            holderSearchView4.txtCategoryYouTubeUrlSearchPoll.setTypeface(face);
            holderSearchView4.imgShareYouTubeUrlSearchPoll.setVisibility(View.GONE);
    ...
    private void validateViewLayoutOne(final ViewHolderLayoutOne holder, final int position) {
        ...
        if(searchPollResponseModel.getUpdatedAt()!=null)
        {
            String strCurrentDate = searchPollResponseModel.getUpdatedAt();
            ...
            holder.txtTimeYesOrNoSearchPoll.setText(date);
        }
        else
        {
        }
    ...
    private void holder1SearchOnClickListner(final ViewHolderLayoutOne holder, final int position) {
        ...
        holder.radioYesSearchPoll.setOnTouchListener((view, motionEvent) -> {
        ...
        holder.radioNoSearchPoll.setOnTouchListener((view, motionEvent) -> {
            int clickPosition = position;  //Click position
            searchPollResponseModel = getItem(clickPosition);  //Getting the item from the response
            if(!view.isClickable()){
                pollAnswerSelectedId = "1";     //poll answer selected id is set as 1
    ...
    private void validateViewLayoutTwo(final ViewHolderLayoutTwo holder, final int position) {
        ...
        if(searchPollResponseModel.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy hh:mm");
            String date = format.format(newDate);
            holder.txtTimeMultipleOptionsSearchPoll.setText(date);
        }
        else
        {
        }
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void validateViewLayoutThree(final ViewHolderLayoutThree holder, final int position) {
        ...
        if(searchPollResponseModel.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy hh:mm");
            String date = format.format(newDate);
            holder.txtTimePhotoComparisonSearchPoll.setText(date);
        }
        else
        {
    ...
    private void validateViewLayoutFour(final ViewHolderLayoutFour holder, final int position) {
        ...
        if(searchPollResponseModel.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy hh:mm");
            String date = format.format(newDate);
            holder.txtTimeYouTubeUrlSearchPoll.setText(date);
        }
        else
        {
        }
