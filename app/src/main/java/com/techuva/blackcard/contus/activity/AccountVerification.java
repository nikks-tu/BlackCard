...
package com.techuva.blackcard.contus.activity;
...
import com.techuva.blackcard.contus.residemenu.MenuActivity;
import com.techuva.blackcard.contus.responsemodel.ContactResponseModel;
import com.techuva.blackcard.contus.responsemodel.MobileNumberChange;
import com.techuva.blackcard.contus.responsemodel.SMSgatewayResponseModel;
import com.techuva.blackcard.contus.responsemodel.SMSverifyModel;
import com.techuva.blackcard.contus.restclient.ContactsRestClient;
import com.techuva.blackcard.contus.restclient.SMSVerifyRestClient;
import com.techuva.blackcard.contus.restclient.SMSgatewayRestClient;
import com.techuva.blackcard.contusfly.activities.ActivityBase;
import com.techuva.blackcard.contusfly.service.ChatService;
...
import com.techuva.blackcard.contusfly.views.CustomToast;
import com.techuva.blackcard.new_changes.api_interface.CheckOtpDataInterface;
...
import static com.techuva.blackcard.contus.app.Constants.CHAT_ONGOING_NAME;
import static com.techuva.blackcard.contus.app.Constants.CITY;
import static com.techuva.blackcard.contus.app.Constants.FCM_REG_ID;
import static com.techuva.blackcard.contus.app.Constants.FIRST_TIME;
import static com.techuva.blackcard.contus.app.Constants.LIVE_BASE_URL;
import static com.techuva.blackcard.contus.app.Constants.MSG_VERIFICATION_CODE;
import static com.techuva.blackcard.contus.app.Constants.OTPCODE;
import static com.techuva.blackcard.contus.app.Constants.PHONE_NUMBER;
import static com.techuva.blackcard.contus.app.Constants.PROFILE_IMAGE;
import static com.techuva.blackcard.contus.app.Constants.PROFILE_USER_NAME;
import static com.techuva.blackcard.contus.app.Constants.VIBRATION_TYPE;
import static com.techuva.blackcard.contusfly.utils.Constants.ACTIVITY_REQ_CODE;
import static com.techuva.blackcard.contusfly.utils.Constants.IS_CONTACTS_SYNCED;
import static com.techuva.blackcard.contusfly.utils.Constants.IS_LOGGED_IN;
import static com.techuva.blackcard.contusfly.utils.Constants.NULL_VALUE;
import static com.techuva.blackcard.contusfly.utils.Constants.SECRET_KEY;
import static com.techuva.blackcard.contusfly.utils.Constants.USERNAME;
import static com.techuva.blackcard.contusfly.utils.Constants.USER_STATUS;


/**
 * Created by user on 6/29/2015.
 */
public class AccountVerification extends ActivityBase implements  Utils.ContactResult  {
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            code = intent.getExtras().getString(OTPCODE);
    ...
    private void init() {
        ...
        phoneNumber = MApplication.getString(mAccountVerification, PHONE_NUMBER);
          ...
          //checkOTPCodeVerification();
            ...
            if (TextUtils.isEmpty(code)) {
                ...
                try {
                    ...
                    MApplication.setString(getApplicationContext(),FCM_REG_ID , refreshedToken);
                    //device_token = refreshedToken;
                    Log.d("Device_token", "Device token: " + refreshedToken);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    "os_name"    : "Android"
                ...
                jsonObject.addProperty("action", "verify_api");
                jsonObject.addProperty("phone_no", phoneCode+phoneNumber);
                ...
                jsonObject.addProperty("android_device_token", device_token);
                serviceCallforOTPValidation(jsonObject);
            }
    ...
    protected void onResume() {
      ...
      //Helper to register for and send broadcasts of Intents to local objects within your process.
        LocalBroadcastManager.getInstance(mAccountVerification).registerReceiver(
                mMessageReceiver, new IntentFilter(MSG_VERIFICATION_CODE));
       //Hides the keyboard
    ...
    private void checkOTPCode() {
        if (MApplication.isNetConnected(mAccountVerification)) {
            ...
            SMSVerifyRestClient.getInstance().postSMSgatewayVerify("verify_api", phoneCode + phoneNumber, code, "Token","Android"
   ...
   /* private void checkMobileNumber() {
    ...
    private void checkMobileNumberResponse(MobileNumberChange mobileNumberChange) {
        ...
        if (("1").equals(success) && ("0").equals(mobileKey)) {
           ...
           password=mobileNumberChange.getResults().getPassword();
            ...
            MApplication.setString(mAccountVerification, PROFILE_IMAGE, profileImage);
            /*Progressive bar stop**/
            googleNow.progressiveStop();
            /*Visibility gone**/
            googleNow.setVisibility(View.GONE);
    ...
    private void serviceCallforOTPValidation(JsonObject jsonObject){
       ...
       // Call<JsonElement> call = service.getStringScalar(new OTPValidatePostParameters("verify_api", phoneCode + phoneNumber, code, device_token, "Android"));
        Call<JsonElement> call = service.getStringScalar(jsonObject);
