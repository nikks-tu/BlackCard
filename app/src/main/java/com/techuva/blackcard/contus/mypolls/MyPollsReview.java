...
public class MyPollsReview extends Activity {
    ...
    public void onBackPressed() {
        MApplication.setBoolean(getApplicationContext(), Constants.IS_MyPolls, true);
        MApplication.setBoolean(getApplicationContext(), Constants.IS_Complaint, false);
    ...
    private void fourthReview(final PollReviewResponseModel pollResponseModelView4) {
        ...
        myPollView4.myPollHeaderNameYouTubeLayout.setTypeface(faceRegular);
        myPollView4.myPolltxtTimeYouTubeLayout.setTypeface(face);
        myPollView4.myPollHeaderCategoryYouTubeLayout.setTypeface(face);
        ...
        if(myPollUpdatedTime!=null)
        {
            String strCurrentDate = myPollUpdatedTime;
            ...
            myPollView4.myPolltxtTimeYouTubeLayout.setText(date);
        }
        else
        {
        }
    ...
    private void thirdReview(PollReviewResponseModel pollReviewResponseModelView3) {
        ...
        myPollView3.myPollPhotoComparisonHeaderImage =  findViewById(R.id.imgProfile);
        ...
        myPollView3.myPollPhotoComparisonHeaderName.setTypeface(faceRegular);
        myPollView3.myPollPhotoComparisontxtTime.setTypeface(face);
        myPollView3.myPollPhotoComparisonHeaderCategory.setTypeface(face);
        //view visible
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void secondReview(PollReviewResponseModel pollResponseModelView2) {
        ...
        myPollView2.myPollHeaderNameMultipleOptions.setTypeface(faceRegular);
        myPollView2.myPolltxtTimeMultipleOptions.setTypeface(face);
        myPollView2.myPollHeaderCategoryMultipleOptions.setTypeface(face);
        //view visible
        ...
        if(myPollUpdatedTime!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy");
            String date = format.format(newDate);
            myPollView2.myPolltxtTimeMultipleOptions.setText(date);
        }
        else
        {
        }
...
//If the user poll image 1 and image 2 is empty then the both the visiblity is gone
    ...
    private void firstReview(PollReviewResponseModel pollResponseModelView1) {
        ...
        myPollView1.myPollHeaderNameYesOrNO.setTypeface(faceRegular);
        myPollView1.myPolltxtTimeYesOrNO.setTypeface(face);
        myPollView1.myPollHeaderCategoryYesOrNO.setTypeface(face);
        ...
        if(myPollUpdatedTime!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy");
            String date = format.format(newDate);
            myPollView1.myPolltxtTimeYesOrNO.setText(date);
        }
        else
        {
        }
