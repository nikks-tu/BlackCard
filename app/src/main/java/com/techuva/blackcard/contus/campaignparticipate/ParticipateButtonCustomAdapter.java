...
public class ParticipateButtonCustomAdapter extends ArrayAdapter<UserPollResponseModel.Results.Data> {
    ...
    private void imageQuestionClickAction(int clickPosition, String pollImageMyPoll) {
        ...
        if(campaignPollResponse.getUpdatedAt()!=null)
        {
            MApplication.setString(participateActivity, Constants.DATE_UPDATED, campaignPollResponse.getUpdatedAt());
        }
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holder2.radioGroupOptionsCampaignPoll = (RadioGroup) mParticipateView.findViewById(R.id.participate_options);
            holder2.radioOptions1MultipleOptionsCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option1);
            holder2.radioOptions2MultipleOptionsCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option2);
            holder2.radioOptions3MultipleOptionsCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option3);
            holder2.radioOptions4MultipleOptionsCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option4);
            holder2.likeUnlikeMultipleOptionsCampaignPoll = (CheckBox) mParticipateView.findViewById(R.id.unLikeDislike);
            holder2.txtLikeMulipleOptionsCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtLike2);
            holder2.txtQuestionMultipleOptionsCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtStatus);
            holder2.txtCommentsMultipleOptionsCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtCommentsCounts);
            holder2.txtCountsMultipleOptionsCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtParticcipation);
            holder2.imageQuestion1MultipleOptionsCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.choose);
            holder2.imageQuestion2MultipleOptionsCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.ChooseAdditional);
            holder2.singleOptionMultipleOptionsCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.singleOption);
            //Binding the data into the views in android
            ...
            holder3.radioOptions1PhotoComparisonCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option1);
            holder3.radioOptions2PhotoComparisonCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option2);
            holder3.radioOptions3PhotoComparisonCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option3);
            holder3.radioOptions4PhotoComparisonCampaignPoll = (RadioButton) mParticipateView.findViewById(R.id.option4);
            holder3.likeUnlikePhotoComparisonCampaignPoll = (CheckBox) mParticipateView.findViewById(R.id.unLikeDislike);
            holder3.txtLikePhotoComparisonCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtLike3);
            holder3.txtQuestionPhotoComparisonCampaignPoll = (TextView) mParticipateView.findViewById(R.id.txtStatus);
            holder3.imageAnswer1PhotoComparisonCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.answer1);
            holder3.imageAnswer2PhotoComparisonCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.answer2);
            holder3.imageAnswer3PhotoComparisonCampaignPoll = (SimpleDraweeView) mParticipateView.findViewById(R.id.answer3);
