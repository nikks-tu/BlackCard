...
import com.techuva.blackcard.contus.responsemodel.CampaignCommentDelete;
import com.techuva.blackcard.contus.responsemodel.CommentDisplayResponseModel;
import com.techuva.blackcard.contus.restclient.CampaignCommentEditDeleteRestClient;
...
import static com.techuva.blackcard.contus.app.Constants.USER_ID;
...
public class CampignPollCommentsAdapter extends ArrayAdapter<CommentDisplayResponseModel.Results.Data> {
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        if (camapignPollCommentsDataResults.getUserId().equals(MApplication.getString(camapignPollCommentsContext, USER_ID))) {
