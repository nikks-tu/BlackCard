...
import com.techuva.blackcard.contus.participation.Participation;
import com.techuva.blackcard.contus.pollreview.PollReviewQuestionParticipation;
...
public class SearchPollReview extends Activity {
    ...
    //txtcomments
    private TextView txtComments, title;
    //view holder
    ...
    private void fourthReview(final PollReviewResponseModel pollResponseModelView4) {
        ...
        searchPollView4.imgShareYouTubeLayout.setVisibility(View.GONE);
    ...
    private void thirdReview(PollReviewResponseModel pollReviewResponseModelView3) {
        ...
        String strCurrentDate = searchPollupdatedTime;
        ...
        searchPollView3.searchPollPhotoComparisontxtTime.setText(date);
        ...
        searchPollView3.searchPollPhotoComparisonimgShare.setVisibility(View.GONE);
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void secondReview(PollReviewResponseModel pollResponseModelView2) {
        ...
        format = new SimpleDateFormat("dd-MMM-yy hh:mm");
        String date = format.format(newDate);
        searchPollView2.searchPolltxtTimeMultipleOptions.setText(date);
...
//If the user poll image 1 and image 2 is empty then the both the visiblity is gone
    ...
    private void firstReview(PollReviewResponseModel pollResponseModelView1) {
        ...
        searchPollView1.imgShareYesOrNO.setVisibility(View.GONE);
        //setting the participate count
        ...
        format = new SimpleDateFormat("dd-MMM-yy hh:mm");
        String date = format.format(newDate);
        searchPollView1.searchPolltxtTimeYesOrNO.setText(date);
