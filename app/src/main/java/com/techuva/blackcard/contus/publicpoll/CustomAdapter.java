package com.techuva.blackcard.contus.publicpoll;
...
import com.techuva.blackcard.contus.campaignparticipate.Participate;
...
public class CustomAdapter extends ArrayAdapter<PublicPollResponseModel.Data> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(publicPollResponse.getUpdatedAt()!=null)
        {
            String strCurrentDate = publicPollResponse.getUpdatedAt();
            ...
            holder.timeShare.setText(MApplication.getTimeDifference(date));
        }
        else
        {
        }
