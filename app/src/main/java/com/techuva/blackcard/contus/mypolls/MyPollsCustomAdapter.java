package com.techuva.blackcard.contus.mypolls;
...
import com.techuva.blackcard.contus.likes.PollLikes;
import com.techuva.blackcard.contus.responsemodel.LikeUnLikeResposneModel;
import com.techuva.blackcard.contus.responsemodel.PollDeleteResponseModel;
import com.techuva.blackcard.contus.responsemodel.PollParticipateResponseModel;
import com.techuva.blackcard.contus.responsemodel.UserPollResponseModel;
import com.techuva.blackcard.contus.restclient.LikesAndUnLikeRestClient;
import com.techuva.blackcard.contus.restclient.PollDelete;
import com.techuva.blackcard.contus.restclient.PollParticipateRestClient;
import com.techuva.blackcard.contus.userpolls.FullImageView;
import com.techuva.blackcard.contus.views.EndLessListView;
import com.techuva.blackcard.contus.views.VideoLandscapeActivity;
...
public class MyPollsCustomAdapter extends ArrayAdapter<UserPollResponseModel.Results.Data> {
    ...
    private View.OnClickListener mMyPollAdapterQuestionImage1 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //This method will be called wto show th eimage in full view
            imageQuestionClickAction(clickPosition, questionImage1MyPoll);
        }
    };
    /**
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        Typeface face = Typeface.createFromAsset(getContext().getAssets(), "fonts/Quicksand-Light.ttf");
        Typeface faceRegular = Typeface.createFromAsset(getContext().getAssets(), "fonts/Quicksand-Regular.otf");
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holderMyPollView1.imgShareYesOrNoMyPOll.setVisibility(View.INVISIBLE);
            holderMyPollView1.txtNameYesOrNoMyPOll.setTypeface(faceRegular);
            holderMyPollView1.txtTimeYesOrNoMyPoll.setTypeface(face);
            holderMyPollView1.txtCategoryYesOrNoMyPoll.setTypeface(face);
          ...
          //  holderMyPollView1.imgShareYesOrNoMyPOll.setImageDrawable(myPollActivity.getResources().getDrawable(R.drawable.arrow_down));
            ...
            holderMyPollView2.imgShareMultipleOptionsMyPoll.setVisibility(View.INVISIBLE);
            ...
            //Binding the data into the views in android
            holderMyPollView2.txtNameMultipleOptionsMyPoll.setTypeface(faceRegular);
            holderMyPollView2.txtTimeMultipleOptionsMyPoll.setTypeface(face);
            holderMyPollView2.txtCategoryMultipleOptionsMyPoll.setTypeface(face);
            ...
            holderMyPollView3.imgSharePhotoComparisonMyPoll.setVisibility(View.INVISIBLE);
            ...
            holderMyPollView3.txtNamePhotoComparisonMyPoll.setTypeface(faceRegular);
            holderMyPollView3.txtTimePhotoComparisonMyPoll.setTypeface(face);
            holderMyPollView3.txtCategoryPhotoComparisonMyPoll.setTypeface(face);
            ...
            holderMyPollView4.imgShareYouTubeUrlMyPoll.setVisibility(View.INVISIBLE);
            holderMyPollView4.txtNameYouTubeUrlMyPoll.setTypeface(faceRegular);
            holderMyPollView4.txtTimeYouTubeUrlMyPoll.setTypeface(face);
            holderMyPollView4.txtCategoryYouTubeUrlMyPoll.setTypeface(face);
    ...
    public void showAlertDialog(final int mClickPosition, String msg, String positiveString, String negativeString) {
        ...
        //builder.setTitle("Alert");//set messag
    ...
    private void clickAction(int clickPosition) {
        ...
        if(myPollResponse.getUpdatedAt()!=null)
        {
            MApplication.setString(myPollActivity, Constants.DATE_UPDATED,myPollResponse.getUpdatedAt());
        }
    ...
    private void validateViewLayoutOne(final ViewHolderLayoutOne holder, final int position) {
        ...
        preferenceUserPollIdAnswer = MApplication.loadStringArray(myPollActivity, userPollIdAnwserCheck, Constants.MY_POLL_ID_ANSWER_ARRAY, Constants.MY_POLL_ID_ANSWER_SIZE);   //Load the poll id from  the saved prefernce
        preferenceUserPollIdAnswerSelected = MApplication.loadStringArray(myPollActivity, userPollIdAnwser, Constants.MY_POLL_ID_ANSWER_SELECTED_ARRAY, Constants.MY_POLL_ID_SELECTED_SIZE);  //Load the answer from  the saved prefernce
        ...
        //Show the poll creation time
        //Getting the time from the response and binding the data into the text view
        if(myPollResponse.getUpdatedAt()!=null)
        {
            String strCurrentDate = myPollResponse.getUpdatedAt();
            ...
            holder.txtTimeYesOrNoMyPoll.setText(date);
        }
        else
        {
        }
    ...
    private void validateViewLayoutTwo(final ViewHolderLayoutTwo holder, final int position) {
        ...
        preferenceUserPollIdAnswer = MApplication.loadStringArray(myPollActivity, userPollIdAnwserCheck, Constants.MY_POLL_ID_ANSWER_ARRAY, Constants.MY_POLL_ID_ANSWER_SIZE);
        //Load the answer from  the saved prefernce
        preferenceUserPollIdAnswerSelected = MApplication.loadStringArray(myPollActivity, userPollIdAnwser, Constants.MY_POLL_ID_ANSWER_SELECTED_ARRAY, Constants.MY_POLL_ID_SELECTED_SIZE);
        ...
        if(myPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimeMultipleOptionsMyPoll.setText(date);
        }
        else
        {
        }
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void shareClickAction(int clickPosition) {
        ...
        MApplication.shareGmail(myPollActivity, shareUrl, MApplication.getString(myPollActivity, Constants.PROFILE_USER_NAME));
    ...
    private void validateViewLayoutThree(final ViewHolderLayoutThree holder, final int position) {
        ...
        if(myPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimePhotoComparisonMyPoll.setText(date);
        }
        else
        {
        }
    ...
    private void holderView3OnClickListner(final ViewHolderLayoutThree holder, final int position) {
        ...
        holder.imageAnswer2PhotoComparisonMyPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Calling a method to on click
                imageQuestionClickAction(clickPosition, pollAnswer2MyPoll);
            }
        });
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.imageAnswer3PhotoComparisonMyPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Calling a method to on click
                imageQuestionClickAction(clickPosition, pollAnswer3MyPoll);
            }
        });
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.imageAnswer4PhotoComparisonMyPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Calling a method to on click
                imageQuestionClickAction(clickPosition, pollAnswer4MyPoll);
            }
        });
        //Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void validateViewLayoutFour(final ViewHolderLayoutFour holder, final int position) {
        ...
        if(myPollResponse.getUpdatedAt()!=null)
        {
            ...
            format = new SimpleDateFormat("dd-MMM-yy HH:mm");
            String date = format.format(newDate);
            holder.txtTimeYouTubeUrlMyPoll.setText(date);
        }
        else
        {
        }
...
//Interface definition for a callback to be invoked when a view is clicked.
    ...
    private void optionSelection(final int clickPosition, final ViewHolderLayoutOne holder1, final ViewHolderLayoutTwo holder2, final ViewHolderLayoutThree holder3, final ViewHolderLayoutFour holder4, String pollAnswerSelectedId, String pollAnswer) {
        ...
        String pollAnswerId = myPollResponse.getUserPollsAns().get(0).getId();
        Log.e("userId", userId + "");
        Log.e("pollId", pollId + "");
        Log.e("pollAnswerId", pollAnswerId + "");
        Log.e("pollAnswer", pollAnswer + "");
        Log.e("pollAnswerSelectedId", pollAnswerSelectedId + "");
        PollParticipateRestClient.getInstance().postParticipateApi(new String("polls_participate"), new String(userId), new String(pollId), new String(pollAnswerId), new String(pollAnswer), new String(pollAnswerSelectedId), new String("1"), new Callback<PollParticipateResponseModel>() {
            @Override
