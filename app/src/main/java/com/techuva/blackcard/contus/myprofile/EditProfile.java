package com.techuva.blackcard.contus.myprofile;
...
import com.techuva.blackcard.contus.responsemodel.EditPersonalInfoModel;
import com.techuva.blackcard.contus.restclient.EditPersonalInfoRestClient;
...
import com.techuva.blackcard.new_changes.locationapi.GooglePlacesAutocompleteActivity;
...
import static com.techuva.blackcard.contus.app.Constants.EMPTY_STRING;
...
public class EditProfile extends ActivityBase implements OnTaskCompleted {
    ...
    private TextView txtCount, txtWelcome;
...
// When the button is pressed or clicked, the state changes automatically.
    ...
    public void onClick(final View clickedView) {
        if (clickedView.getId() == R.id.txtNext) {
            ...
            MApplication.setBoolean(getApplicationContext(), Constants.FromEditProfile, true);
